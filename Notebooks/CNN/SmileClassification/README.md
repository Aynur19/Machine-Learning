...
|---|---|---|---|---|---|---|
|1|50%/50%|Dense(1024,"relu")<br>Dense(3)|91.33%|53.85%|0.311|1.104|
|2|50%/50%|Dense(1024,"softmax")<br>Dense(3)|87.00%|57.37%|0.510|0.952|
|3|80%/20%|Dense(1024,"relu")<br>Dense(3)|92.24%|90.98%|0.236|0.298|
|4|80%/20%|Dense(1024,"softmax")<br>Dense(3)|82.86%|78.69%|0.514|0.605|
...
|4|50%/50%|Conv2D(1024,"sigmoid")<br>MaxPooling2D(512)<br>Dense(512,"softmax")<br>Dense(3,"softmax")|33.33%|31.73%|1.099|1.100|
|5|50%/50%|Conv2D(1024,"tanh")<br>MaxPooling2D(512)<br>Dense(512,"softmax")|96.67%|64.42%|0.152|0.782|
|6|50%/50%|Conv2D(1024,"tanh")<br>MaxPooling2D(512)<br>Dense(3,"softmax")|98.67%|67.63%|0.094|0.824|
|7|50%/50%|Conv2D(1024,"tanh")<br>MaxPooling2D(512)<br>Conv2D(512,"sigmoid")<br>MaxPooling2D(256)<br>Dense(256,"relu")<br>Dense(3)||86.33%|63.78%|0.425|0.805|
|8|50%/50%|Conv2D(1024,"sigmoid")<br>MaxPooling2D(512)<br>Conv2D(512,"tanh")<br>MaxPooling2D(256)<br>Dense (256,"relu")<br>Dense(3)|99.33%|73.72%|0.052|0.742|
|9|50%/50%|Conv2D(1024,"tanh")<br>MaxPooling2D(512)<br>Conv2D(512,"sigmoid")<br>MaxPooling2D(256)<br>Dense(256,"softmax")<br>Dense(3,"softmax")|56.33%|39.10%|0.948|1.107|
|10|50%/50%|Conv2D(1024,"sigmoid")<br>MaxPooling2D(512)<br>Conv2D(512,"tanh")<br>MaxPooling2D(256)<br>Dense(256,"softmax")<br>Dense(3,"softmax")|93.67%|66.03%|0.736|0.968|
|11|80%/20%|Conv2D(1024,"tanh")<br>MaxPooling2D(512)<br>Dense(512,"relu")<br>Dense(3)|99.80%|93.44%|0.037|0.131|
|12|80%/20%|Conv2D(1024,"sigmoid")<br>MaxPooling2D(512)<br>Dense(512,"relu")<br>Dense(3)|53.47%|50.00%|0.976|0.974|
|13|80%/20%|Conv2D(1024,"tanh")<br>MaxPooling2D(512)<br>Dense(512,"softmax")<br>Dense(3,"softmax")|66.12%|67.21%|0.753|0.760|
|14|80%/20%|Conv2D(1024,"sigmoid")<br>MaxPooling2D(512)<br>Dense(512,"softmax")<br>Dense(3,"softmax")|33.67%|34.43%|1.099|1.098|
|15|80%/20%|Conv2D(1024,"tanh")<br>MaxPooling2D(512)<br>Dense(512,"softmax")|97.76%|93.44%|0.131|0.179|
|16|80%/20%|Conv2D(1024,"tanh")<br>MaxPooling2D(512)<br>Dense(3,"softmax")|98.16%|96.72%|0.096|0.149|
|17|80%/20%|Conv2D(1024,"tanh")<br>MaxPooling2D(512)<br>Conv2D(512,"sigmoid")<br>MaxPooling2D(256)<br>Dense(256,"relu")<br>Dense(3)|98.98%|96.72%|0.075|0.115|
|18|80%/20%|Conv2D(1024,"sigmoid")<br>MaxPooling2D(512)<br>Conv2D(512,"tanh")<br>MaxPooling2D(256)<br>Dense(256,"relu")<br>Dense(3)|99.59%|98.36%|0.023|0.071|
|19|80%/20%|Conv2D(1024,"tanh")<br>MaxPooling2D(512)<br>Conv2D(512,"sigmoid")<br>MaxPooling2D(256)<br>Dense(256,"softmax")<br>Dense(3,"softmax")|65.92%|65.57%|0.777|0.788|
|20|80%/20%|Conv2D(1024,"sigmoid")<br>MaxPooling2D(512)<br>Conv2D (512,"tanh")<br>MaxPooling2D(256)<br>Dense(256,"softmax")<br>Dense(3,"softmax")|67.55%|67.21%|0.738|0.732|
