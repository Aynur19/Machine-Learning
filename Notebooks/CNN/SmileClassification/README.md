...
|---|---|---|---|---|---|---|---|---|---|---|
|1|50%/50%|30 / 32|Dense(1024,"relu")<br>Dense(3)|Adam|0.001|Sparse Categorical Crossentropy|91.33%|53.85%|0.311|1.104|
|2|50%/50%|30 / 32|Dense(1024,"softmax")<br>Dense(3)|Adam|0.001|Sparse Categorical Crossentropy|87.00%|57.37%|0.510|0.952|
|3|80%/20%|30 / 32|Dense(1024,"relu")<br>Dense(3)|Adam|0.001|Sparse Categorical Crossentropy|92.24%|90.98%|0.236|0.298|
|4|80%/20%|30 / 32|Dense(1024,"softmax")<br>Dense(3)|Adam|0.001|Sparse Categorical Crossentropy|82.86%|78.69%|0.514|0.605|
